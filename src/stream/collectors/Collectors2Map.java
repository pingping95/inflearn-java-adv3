...
public class Collectors2Map {
    ...
    public static void main(String[] args) {
        ...
        LinkedHashMap<String, Integer> map4 = Stream.of("Apple", "Apple", "Tomato")
                .collect(Collectors.toMap(
                        name -> name, // keyMapper: 문자열 자체를 key로 사용
                        String::length, // valueMapper: 문자열 길이를 value로 사용
                        (oldVal, newVal) -> oldVal + newVal, // mergeFunction: 키 중복 시 기존 값과 새 값을 합산
                        LinkedHashMap::new  // mapSupplier: 결과로 LinkedHashMap 생성
                ));
