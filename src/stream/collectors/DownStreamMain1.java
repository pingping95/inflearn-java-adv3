...
public class DownStreamMain1 {
    ...
    public static void main(String[] args) {
        ...
        Map<Integer, List<String>> collect2 = students.stream()
                .collect(Collectors.groupingBy(
                        Student::getGrade,  // 그룹화 기준 : 학년
                        Collectors.mapping(Student::getName,    // 다운스트림1 : 각 학생 요소들의 이름을 반환
                                Collectors.toList())
                ));
        ...
        Map<Integer, Double> collector4 = students.stream()
                .collect(Collectors.groupingBy(
                        Student::getGrade,
                        Collectors.averagingInt(Student::getScore)
                ));
        System.out.println("collector4 = " + collector4);
