...
public class OptionalRetrievalMain {
    ...
    public static void main(String[] args) {
        ...
        // String getValue2 = optEmpty.get();   // -> 예외 발생하여 주석 처리
        ...
        System.out.println("result1 = " + result1); // Optional[Hello], 값이 이미 존재 -> 원본 그대로
